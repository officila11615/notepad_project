  ...
  if (!note) {
    return (
      <div className="flex flex-col items-center justify-center h-full text-center text-muted-foreground p-8">
        <NotebookPen className="w-16 h-16 mb-4" />
    ...
    <TooltipProvider>
      <div className="flex flex-col h-full">
        ...
        <div className="flex-grow flex flex-col p-4 md:p-6">
          <Input
            ...
            className="text-2xl md:text-3xl font-bold border-none shadow-none focus-visible:ring-0 px-0 h-auto mb-4"
          />
          <ScrollArea className="flex-grow">
            <Textarea
              ...
              className="flex-grow w-full h-full resize-none border-none shadow-none focus-visible:ring-0 px-0 text-base leading-relaxed"
            />
          </ScrollArea>
        </div>
      </div>
      ...
      <Dialog open={isSummaryDialogOpen} onOpenChange={setIsSummaryDialogOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2"><Sparkles className="h-5 w-5 text-primary" /> AI Summary</DialogTitle>
            <DialogDescription>
